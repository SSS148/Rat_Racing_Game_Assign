...
namespace Racing_Game_AssignS
{
    public partial class Form1 : Form
    {
        ...
        private void setBet_Click(object sender, EventArgs e)
        {
            ...
            if (Sahil.Checked == false && Dashmesh.Checked == false && Higor.Checked == false)
            {
                ...
                if (Sahil.Checked == true && selectedRat > 0) {
                    ...
                    if (Convert.ToInt32(nmBet.Value)<51 && Convert.ToInt32(nmBet.Value) < sahilBudget) {
                    ...
                    //if we choose the player then we must verify the amount for the bet
                    if (Convert.ToInt32(nmBet.Value) < 51 && Convert.ToInt32(nmBet.Value) < dashmeshBudget)
                    {
                        //after filling the amount disolay the catalog to show which player choose how much amount 
                    ...
                    //if we choose the player then we must verify the amount for the bet
                    if (Convert.ToInt32(nmBet.Value) < 51 && Convert.ToInt32(nmBet.Value) < higorBudget)
                    {
                        //after filling the amount disolay the catalog to show which player choose how much amount 
        ...
        public void resultAnnounce() {
            ...
            if (lblHigor.Text.Contains("Higor"))
            {
        ...
        private void Dashmesh_CheckedChanged(object sender, EventArgs e)
        {
            if (Dashmesh.Checked == true) {
                Sahil.Checked = false;
                Higor.Checked = false;
            }
        }

        private void Higor_CheckedChanged(object sender, EventArgs e)
        {
            if (Higor.Checked == true)
            {
                Sahil.Checked = false;
                Dashmesh.Checked = false;
            }
